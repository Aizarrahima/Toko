        ...
        <div class="py-4 text-gray-500 dark:text-gray-400">
            ...
            <ul>
                ...
                <li class="relative px-6 py-3">
                    ...
                    <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 text-gray-800 dark:text-gray-100 hover:text-gray-800 dark:hover:text-gray-200" href="<?= ROUTE_URL ?>/penjualan">
                        <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div class="flex flex-col flex-1 w-full">
        ...
        <main class="h-full pb-16 overflow-y-auto">
            <div class="container px-6 mx-auto grid">
                ...
                <!-- General elements -->
                <form action=" <?= ROUTE_URL; ?>/penjualan/edit_submit" method="post">
                    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                        <label class="block text-sm">
                            <span class="text-gray-700 dark:text-gray-400">Jumlah Penjualan</span>
                            <div class="relative text-gray-500 focus-within:text-purple-600 dark:focus-within:text-purple-400">
                                <input type="number" name="JumlahPenjualan" class="block w-full pr-10 mt-1 text-sm text-black dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray form-input" value="<?= $data['penjualan']['JumlahPenjualan']; ?>" />
                        ...
                        <label class="block mt-4 text-sm">
                            ...
                            <input type="text" name="HargaJual" id="NamaDepan" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" value=" <?= $data['penjualan']['HargaJual']; ?>" />
                        </label>
                        ...
                        <label class=" block mt-4 text-sm hidden">
                            <span class="text-gray-700 dark:text-gray-400"> Id Penjualan </span>
                            <input name="IdPenjualan" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" value="<?= $data['penjualan']['IdPenjualan']; ?>" />
                        </label>
                        <!-- Button -->
                        <div class="flex">
                            <div class=" pl-4 my-6">
                                <a href="<?= ROUTE_URL ?>/penjualan" class="flex items-center justify-between px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 border rounded-lg dark:border-gray-600 dark:bg-gray-400 bg-gray-400 active:bg-gray-600 hover:bg-gray-700 focus:outline-none focus:shadow-outline-gray">
                                    Back
                                </a>
                            </div>
                            <div class=" px-6 my-6">
