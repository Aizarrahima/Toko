                ...
                <form action="" method="">
                    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                        <label class="block text-sm">
                            ...
                            <input type="text" name="JumlahPenjualan" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" value="<?= $data['penjualan']['JumlahPenjualan']; ?> Unit" readonly />
                        </label>

                        <label class="block mt-4 text-sm">
                            <span class="text-gray-700 dark:text-gray-400">Harga Jual</span>
                            <input type="text" name="HargaJual" id="NamaDepan" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" value=" Rp <?= number_format($data['penjualan']['HargaJual'], 0, ',', '.'); ?>" readonly />
                        </label>
                        ...
                        <label class="block mt-4 text-sm">
                            ...
                            <input type="text" name="IdPengguna" id="IdPengguna" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" value="<?= $data['penjualan']['NamaPengguna']; ?>" readonly />
                        </label>
                </form>
                <!-- Button -->
                <div class="flex">
