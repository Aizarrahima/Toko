                ...
                <form action="<?= ROUTE_URL; ?>/barang/create" method="post">
                    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                        <label class="block text-sm">
                            ...
                            <input type="text" name="NamaBarang" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="please input name of barang...." />
                        </label>
                        ...
                        <label class="block mt-4 text-sm">
                            ...
                            <input type="text" name="Satuan" id="NamaDepan" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="please input satuan like buah, unit, etc...." />
                        </label>
